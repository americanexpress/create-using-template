...
##### `dynamicFolderNames` object<string, string>, optional
...
```jsx
const dynamicFolderNames = {
  'marketLocale': `en-AU`,
};
```
Note that the folder name you provide should be the name itself, do not provide path of the folder like `src/locale`, provide only name 'locale' along with the value you want it to be renamed with.
