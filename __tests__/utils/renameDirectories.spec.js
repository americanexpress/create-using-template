...
describe('renameDirectories', () => {
  ...
  it('should recurse if a file in that directory is a directory', () => {
    ...
    renameDirectories('output/root/path/mock', templateOptionsMock);

    expect(fs.readdirSync).toHaveBeenCalledTimes(2);
  });

  it('should call the rename function if dynamicDirectoryNames exists', () => {
    ...
    templateOptionsMock.dynamicDirectoryNames = { folder1: 'folder1Renamed' };
