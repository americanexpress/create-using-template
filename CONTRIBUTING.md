# Contributing to create-using-template
...
1. Fork the repository `create-using-template` to your GitHub account.
2. Afterwards run the following commands in your terminal

    ```bash
    $ git clone https://github.com/<your-github-username>/create-using-template
